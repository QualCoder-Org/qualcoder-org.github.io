...
Sobald alle Schritte abgeschlossen sind, zeigt die Statusleiste „AI: ready“ an. Nun können der [KI-Chat](https://qualcoder.org/doc/en/5.1.-AI-chat-based-analysis) oder das [KI-gestützte Coding](https://qualcoder.org/doc/en/4.2.-AI-Assisted-Coding) zur Untersuchung der Daten genutzt werden.
