...
<img width="965" height="517" alt="image" src="https://github.com/user-attachments/assets/71172904-3ae5-4eb3-9b04-350f036f1c9d" />


## Importing files

Import text from plain text documents, docx, epub, md, odt, pdf, rtf and tex (LaTex.tex - Complex presentations may not import perfectly, |input and |include files are not resolved). Import images from: jpg, jpeg, and png. Import audio/video formats: mp3, m4a, mp4, wav, mov, ogg. PDFs can be coded as text or as images. Alternatively, rather than importing files into the project folder, you can link to files locally in your computer's file system. This may be a good option if you have a specific folder structure that is important to your project.
