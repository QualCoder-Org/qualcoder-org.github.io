...
Text files containing emoticons can be importedand displayed.Howver, emoticons can 'offset' subsequent coding strips, by 1 character per emoticon. This occurs mainly when using the auto-code exact textbutton.
