...
**ERROR IDENTIFIED in version 3.8: When coding exact text and selecting multiple files,the autocoding process stops, as soon as it files a file with no matching text, and does not continue with the subsequent files. 
