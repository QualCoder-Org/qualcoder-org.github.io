...
This name will be used to identify your contributions to the project. Click the "Change" button to alter your identity or to create, rename, or merge other coders within the current project. This will show the following dialog:

<img width="500" alt="Coder dialog" src="https://github.com/user-attachments/assets/380291b1-6e34-4bd3-8344-182af8448140" />

Be careful, especially with the Merge function, as there is no undo. If you make a mistake, cancel the dialog, and the changes will be revertet. After clicking OK, they are permanent.   

You can also manage the visibility of other collaborators here. This window is also accessible from the toolbar in the code text, code image, and code PDF workspaces, albeit with more limited options. 
