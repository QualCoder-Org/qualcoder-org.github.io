...
Multiple coders can code and annotate the same text. Your own coder name is displayed at the top of the settings dialog. This name will be used to identify your contributions to the project. Click the "..." button to change your identity or to create, rename, or merge other coders within the current project. You can also manage the visibility of other collaborators here. This window is also accessible from the toolbar in the code text, code image, and code PDF workspaces. 
