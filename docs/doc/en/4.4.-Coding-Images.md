...
PDFs can be image coded. The image rendering within QualCoder is not sharp but usable. The image can be exported and is sharper quality.
...
These highlight options are: greyed out, blur, solarise, and they open in your default image viewign program to view and save.
