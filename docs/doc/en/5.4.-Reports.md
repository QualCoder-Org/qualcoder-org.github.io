...
Right-click on a code for more options:

<img width="180" height="60" alt="image" src="https://github.com/user-attachments/assets/ad6903e9-1f1a-4901-92c4-9c7e00d174e4" />
...
<img width="180" height="60" alt="image" src="https://github.com/user-attachments/assets/2a499964-a0c6-4961-ae7e-d1851bf0d549" />
...
Right-click on the files for more options:

<img width="250" height="250" alt="image" src="https://github.com/user-attachments/assets/05dbe1fd-f4ae-4899-99c9-df274ae43f12" />
...
Files or cases by codes, and shows code frequency heat.

![image](/images/fede18af-02c9-4ea2-af09-ee1355e7dc21.png)

_Stacked bar charts_

Files or cases by codes, and shows code frequency as a stacked bar chart.
...
As you are able to perform any database queries, including updating data and deleting tables, keep backup copies otherwise it is possible to irreparably destroy the database.
