...
=== "Debian / Ubuntu / Lubuntu / ZorinOS Linux"
    ...
    There is an executable file in the releases page for Ubuntu 24.04 for the 3.8 release. Download and double click to run. You might first need to right-click and go to Properties, then check the Exectuable checkbox.
