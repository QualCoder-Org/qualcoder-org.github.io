...
[:octicons-archive-24: Latest Beta release of QualCoder (4.0) available on GitHub]([https://github.com/ccbogel/QualCoder/releases#release-4.0-Beta](https://github.com/ccbogel/QualCoder/releases#release-4.0-Beta)){ .md-button .md-button--primary }
