...
Clic droit sur un code pour plus d’options :

![image](/images/gh-05dbe1fd-f4ae-4899-99c9-df274ae43f12.png)
...
![image](/images/gh-2a499964-a0c6-4961-ae7e-d1851bf0d549.png)
...
![image](/images/gh-ad6903e9-1f1a-4901-92c4-9c7e00d174e4.png)
...
De nombreux graphiques sont affichés dans le navigateur web par défaut. Si votre navigateur n’affiche pas votre graphique, changez pour navigateur web par défeut par une version plus récente, comme Firefox, Chrome, Edge ou Safari. Si vous avez javascript désactivé, les graphiques ne s’afficheront pas. Cocher la case *Exporter le fichier HTML* entraînera l’export de tous les graphiques vers le dossier d'export par défaut sous forme de fichier HTML.
...
Fichier ou de cas par codes et affiche une carte thermique de la fréquence des codes.
...
Fichier ou des cas par codes et affiche la fréquence des codes sous forme de graphiques à barres empilées.
...
Comme vous pouvez effectuer toutes les requêtes de base de données, y compris la mise à jour des données et la suppression des tables, conservez des copies de sauvegarde, faute de quoi il est possible de détruire irrémédiablement la base de données.