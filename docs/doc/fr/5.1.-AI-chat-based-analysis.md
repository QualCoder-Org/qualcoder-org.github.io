...
- Is based on the same search technology that also powers the [AI Assisted Coding](https://github.com/ccbogel/QualCoder/wiki/4.2.-AI-Assisted-Coding). 
...
2) Select an **analytic prompt:**
   ...
   (As an advanced option, you can also define your own analytic prompts by clicking on the “Edit” button, which opens the [AI Prompt Library](https://github.com/ccbogel/QualCoder/wiki/6.2.-AI-Prompt-Library).)
...
If you want to **define your own types of text analysis**, you can do so by adding them to the [AI Prompt Library](https://github.com/ccbogel/QualCoder/wiki/6.2.-AI-Prompt-Library) (advanced option).
