...
Le menu Projet contient la plupart des fonctions d’imports et d’export.

![img](/images/gh-d7a4f38a-4175-4a8d-9bb4-32a8e50d9bb4.png)

Options similaires pour les exports :

![images](/images/gh-d2d1f30f-4058-4533-a568-b814a1b72e82.png)

Les enquêtes peuvent être importées dans le gestionnaire de fichier.
...
Importez une grille de codage sous forme de fichier texte brut (.txt) ou de fichier .csv. Utilisez deux symboles « supérieur à » pour séparer la catégorie et le code.  Utilisez trois symboles « supérieur à » pour définir un bloc de code imbriqué.
