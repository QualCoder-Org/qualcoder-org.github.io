...
« Surligner les intervenant⋅es » crée des codes pour chaque itervenant⋅e dans un entretien ou une discussion de groupe, assignant automatiquement un verbatime. 
"Mark speakers" creates codes for every speaker in an interview or group discussion, and assigns utterances automatically. Vous pouvez y accéder via le menu contextuel du fichier ou le bouton suivant de la barre d'outils : 
