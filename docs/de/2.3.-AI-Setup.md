...
In QualCoder kann zwischen verschiedenen Large Language Models gewählt werden; es ist sogar möglich, [eigene Modelle hinzuzufügen](#using-other-ai-models). Standardmäßig sind folgende Dienste implementiert:
...
* __Weitere KI-Anbieter finden Sie [weiter unten](#using-other-ai-models).__
...
Sobald alle Schritte abgeschlossen sind, zeigt die Statusleiste „AI: ready“ an. Nun können der [KI-Chat](https://qualcoder-org.github.io/doc/en/5.1.-AI-chat-based-analysis) oder das [KI-gestützte Coding](https://qualcoder-org.github.io/doc/en/4.2.-AI-Assisted-Coding) zur Untersuchung der Daten genutzt werden.
