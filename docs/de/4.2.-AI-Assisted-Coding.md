...
- **Unterstütztes, nicht automatisiertes Coding:** Im Gegensatz zum schlüsselwortbasierten [Auto-Coding](https://qualcoder-org.github.io/doc/en/4.1.-Coding-Text#auto-code) handelt es sich hierbei nicht um einen automatisierten Prozess. Die Vorschläge der KI sind zu prüfen.
...
**Die Prompts können erkundet werden**, indem der Mauszeiger über die Einträge in der Dropdown-Liste bewegt wird. Über „Bearbeiten“ können die [analytischen Prompts angepasst oder eigene definiert werden](https://qualcoder-org.github.io/doc/en/6.2.-AI-Prompt-Library) (Option für Fortgeschrittene).
...
Der **ausgewählte Text kann codiert werden**, wie jeder andere Text im [Text-Coding-Arbeitsbereich](https://qualcoder-org.github.io/doc/en/4.1.-Coding-Text). Die Auswahl kann bei Bedarf erweitert oder geändert werden.
