...
This helper file for this: rebuild_lang.py will update all the placeholders for the languages in both po and ts files. Run from the Qualcder-master efolder.
...
# note don't use -j lang.po on first creating a po file





For individual updates to po file,s see below example for Deutsch:
